<template>
  <div class="privacy">
    <div class="t-project-title">Andy Karwoski Websites & App Privacy Policy</div>
    <div class="t-project-details">
      By accessing this website we assume you accept these terms and conditions in full. Do not
      continue to use Andy Karwoski's website or applications if you do not accept all of the terms
      and conditions stated on this page. The following terminology applies to these Terms and
      ...
      undertake the process of our assistance to the Client in the most appropriate manner, whether
      by formal meetings of a fixed duration, or any other means, for the express purpose of meeting
      the Client’s needs in respect of provision of the Company’s stated services/products, in
      accordance with and subject to, prevailing law of Japan. Any use of the above terminology or
      other words in the singular, plural, capitalisation and/or he/she or they, are taken as
      interchangeable and therefore as referring to same.
    </div>

    <div class="t-project-title">License</div>
    <div class="t-project-details">
      Unless otherwise stated, Andy Karwoski and/or it’s licensors own the intellectual property
      rights for all material on https://andykarwoski.com. All intellectual property rights are
      reserved. You may view and/or print pages from https://andykarwoski.com for your own personal
      use subject to restrictions set in these terms and conditions. You must not: Redistribute
      content from Andy Karwoski (unless content is specifically made for redistribution).
      Hyperlinking to our Content
    </div>

    <div class="t-project-title">
      The following organizations may link to our Web site without prior written approval:
    </div>

    <div class="t-project-details">
      Government agencies; Search engines; News organizations; Online directory distributors when
      they list us in the directory may link to our Web site in the same manner as they hyperlink to
      the Web sites of other listed businesses; and Systemwide Accredited Businesses except
    ...
    <div class="t-project-details">
      ...
      sponsorship, endorsement or approval of the linking party and its products or services; and
    ...
    <div class="t-project-details">
      ...
      directory distributors; internet portals; accounting, law and consulting firms whose primary
    ...
    <div class="t-project-details">
      ...
      the hyperlink outweighs the absence of ; and (d) where the link is in the context of general
      resource information or is otherwise consistent with editorial content in a newsletter or
    ...
    <div class="t-project-details">
      ...
      to our website, you must notify us by sending an e-mail to info@cine-match.com. Please include
      ...
      our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3
    ...
    <div class="t-project-details">
      By use of our corporate name; or By use of the uniform resource locator (Web address) being
      linked to; or By use of any other description of our Web site or material being linked to that
    ...
    <div class="t-project-title">Reservation of Rights</div>
    <div class="t-project-details">
    ...
    <div class="t-project-title">Removal of links from our website</div>
    <div class="t-body">
    ...
    <div class="t-project-title">Content Liability</div>
    <div class="t-body">
